        ...
        **fit_params : dict of string -> object
        ...
        with _print_elapsed_time('Pipeline',
            ...
            if hasattr(last_step, 'fit_transform'):
                ...
                fitted = last_step.fit(Xt, yt, **fit_params_last_step)
                try:
                    transformed = fitted.transform(Xt, yt)
                except Exception:

                    transformed = fitted.transform(Xt)
        ...
        if y is None:
            ...
            for _, _, transform in self._iter():
                try:
                    ...
                    print(f"No transform on y for {transform}.")
                    Xt = transform.transform(Xt)
            return Xt, yt
